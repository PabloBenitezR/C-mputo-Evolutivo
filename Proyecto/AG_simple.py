...
class AlgoritmoGenetico(object):
    def __init__(self,
        ...
        #def crossover1(parent_1,parent_2): # cambio de cruza por bloques
        #    child_1= []
        #    child_2= []
        #    block_length = 47
        #    for i in range (0, len(parent_1), block_length):
        #        if random.random() < 0.5:
        #            child_1 += parent_1[i:i + block_length]
        #            child_2 += parent_2[i:i + block_length]
        #        else:
        #            child_1 += parent_2[i:i + block_length]
        #            child_2 += parent_1[i:i + block_length]
        #    return child_1, child_2
